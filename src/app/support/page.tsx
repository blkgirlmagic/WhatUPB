...
export const metadata = {
  title: "Support — CoinRep",
  description:
    "Get help with your CoinRep account, subscription, or platform questions.",
};
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
          <section>
            <p style={{ color: "#4b5563", fontSize: 14, lineHeight: 1.7 }}>
              Welcome to the CoinRep Support Center. If you need help with your account, subscription, or have questions about using the platform, please contact our support team.
            </p>
          </section>
          ...
          <section>
            ...
            <ul style={{ listStyle: "disc", paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
              <li style={{ color: "#6b7280", fontSize: 14, lineHeight: 1.7 }}><strong style={{ color: "#4b5563" }}>Email:</strong>{" "}<a href="mailto:contact.coinrep@gmail.com" style={{ color: "#8b5cf6", textDecoration: "underline" }}>contact.coinrep@gmail.com</a></li>
            </ul>
          ...
          <section>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div>
                ...
                <p style={{ color: "#6b7280", fontSize: 14, lineHeight: 1.7 }}>Email us at <a href="mailto:contact.coinrep@gmail.com" style={{ color: "#8b5cf6", textDecoration: "underline" }}>contact.coinrep@gmail.com</a> with the subject &quot;Account Deletion&quot; and we&apos;ll process it within 30 days.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p style={{ color: "#6b7280", fontSize: 14, lineHeight: 1.7 }}>Report it by emailing <a href="mailto:contact.coinrep@gmail.com" style={{ color: "#8b5cf6", textDecoration: "underline" }}>contact.coinrep@gmail.com</a>. If you&apos;re in crisis, visit our <Link href="/safety" style={{ color: "#8b5cf6", textDecoration: "underline" }}>Safety Resources</Link> page.</p>
              </div>
            </div>
          </section>
