...
export const metadata = {
  title: "Terms of Service — CoinRep",
  description: "Terms and conditions for using CoinRep.",
};
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
          <section>
            <p style={{ color: "#4b5563", fontSize: 14, lineHeight: 1.7 }}>
              CoinRep is operated by Aurora Bridge LLC. By creating an account or using CoinRep, you agree to these Terms of Service. If you do not agree, do not use the service.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ color: "#4b5563", fontSize: 14, lineHeight: 1.7 }}>
              You must be at least 18 years old to use CoinRep. By creating an account, you confirm that you are 18 or older. We verify your age during the signup process. If we discover that a user is under 18, we will terminate their account immediately.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ color: "#4b5563", fontSize: 14, lineHeight: 1.7 }}>
              Users are solely responsible for the content they send through CoinRep, including anonymous messages. While messages are anonymous, users must comply with our{" "}
          ...
          <section>
            ...
            <p style={{ color: "#4b5563", fontSize: 14, lineHeight: 1.7, marginBottom: 12 }}>You may not use CoinRep to send, share, or facilitate any of the following:</p>
          ...
          <section>
            ...
            <p style={{ color: "#4b5563", fontSize: 14, lineHeight: 1.7, marginBottom: 12 }}>CoinRep offers optional paid subscription plans. By subscribing, you agree to the following:</p>
            <ul style={{ listStyle: "disc", paddingLeft: 20, display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <section>
            ...
            <p style={{ color: "#4b5563", fontSize: 14, lineHeight: 1.7 }}>
              CoinRep is provided &quot;as is&quot; and &quot;as available&quot; without warranties of any kind, either express or implied, including but not limited to implied warranties of merchantability, fitness for a particular purpose, and non-infringement. We do not guarantee that the service will be uninterrupted, secure, or error-free.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ color: "#4b5563", fontSize: 14, lineHeight: 1.7 }}>
              We may update these Terms of Service from time to time. If we make significant changes, we will notify you by email or through the service. Your continued use of CoinRep after changes are posted constitutes acceptance of the updated terms.
            </p>
          </section>
