...
export const metadata = {
  title: "THE TURN Brief | WhatUPB Intelligence",
  description:
    "WhatUPB Intelligence Brief 002 — THE TURN: Bitcoin's $85K breakout, ETF flows, Ethereum's recovery, and the on-chain signals that define the cycle.",
};

export default function TheTurnPage() {
  const report = getReport("the-turn");
  if (!report) notFound();
    ...
    <div className="wb-page">
        ...
        <div className="wb-brief-inside-inner">
          ...
          <div className="wb-brief-inside-grid">
            <div className="wb-brief-inside-item">
              ...
              <div className="wb-brief-inside-label">Bitcoin&apos;s $85K Breakout</div>
              <p className="wb-brief-inside-desc">
                What drove BTC through the $85K level, what changed structurally
                at that price, and whether the on-chain data supports continuation
                or signals a retest.
              </p>
            </div>
            <div className="wb-brief-inside-item">
              <div className="wb-brief-inside-icon">📈</div>
              <div className="wb-brief-inside-label">ETF Flows</div>
              <p className="wb-brief-inside-desc">
                Spot Bitcoin and Ethereum ETF inflow data — which funds are
                absorbing supply, how institutional positioning has shifted, and
                what flows historically precede sustained moves.
              </p>
            </div>
            <div className="wb-brief-inside-item">
              <div className="wb-brief-inside-icon">◈</div>
              <div className="wb-brief-inside-label">Ethereum&apos;s Recovery</div>
              <p className="wb-brief-inside-desc">
                ETH&apos;s lag, recovery dynamics, and what the ETH/BTC ratio and
                staking data reveal about whether capital is rotating or concentrating.
              </p>
            </div>
            <div className="wb-brief-inside-item">
              <div className="wb-brief-inside-icon">⚡</div>
              <div className="wb-brief-inside-label">Signals That Confirm — or Challenge</div>
              <p className="wb-brief-inside-desc">
                Leverage, funding rates, realized cap, and the three on-chain
                metrics WhatUPB watches to distinguish a genuine cycle turn from
                a high-leverage fakeout.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="wb-brief-why">
        <div className="wb-brief-why-inner">
          <div className="wb-brief-why-quote">
            &ldquo;Everyone is calling the turn. THE TURN tells you what the
            data actually says — and what would have to be true for them to be
            right.&rdquo;
          </div>
          <div className="wb-brief-why-attr">— WhatUPB Editorial</div>
          <div className="wb-brief-why-bullets">
            <div className="wb-brief-why-bullet">✓ Sourced from on-chain data, ETF filings, and public exchange disclosures</div>
            <div className="wb-brief-why-bullet">✓ No price targets. No trading calls. Signal, not noise.</div>
            <div className="wb-brief-why-bullet">✓ Written for investors, analysts, and operators navigating the next cycle</div>
            <div className="wb-brief-why-bullet">✓ Ten pages. Everything that matters about where crypto stands right now.</div>
          </div>
        </div>
      </section>
      ...
      <div className="wb-bottom-cta">
        <div className="wb-bc-title">
          Ten pages. The data behind<br />THE TURN.
        </div>
